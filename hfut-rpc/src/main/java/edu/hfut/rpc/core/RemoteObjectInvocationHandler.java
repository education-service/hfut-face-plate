...
import edu.hfut.api.utils.RpcUtils;
import edu.hfut.rpc.io.ByteBufferBackedInputStream;
import edu.hfut.rpc.io.ByteBufferBackedOutputStream;
...
public class RemoteObjectInvocationHandler implements InvocationHandler {
	...
	public RemoteObjectInvocationHandler(String remoteHost, int remotePort, Class<?> serviceType, Serializer serializer) {
		...
		method2CodeMap = RpcUtils.getMethod2CodeMap(serviceType);
