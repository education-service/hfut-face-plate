...
public class PlateRecognitionDistributionMapper extends Mapper<NullWritable, BufferedImageWritable, Text, Text> {
	...
	protected void setup(Context context) throws IOException {
		...
		// 序列化人脸识别样本库目录
		Path facesDBSeq = new Path(conf.get("platesdbseq"));
		faceSamples = PlateRecognitionDistribution.readFaceSamples(conf, facesDBSeq);
	}
